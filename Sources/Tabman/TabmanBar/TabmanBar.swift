...
open class TabmanBar: UIView, TabmanBarLifecycle {
    ...
    public internal(set) var indicator: TabmanBarIndicator? {
        didSet {
    ...
    public var preferredIndicatorStyle: TabmanBarIndicator.Style? {
        didSet {
    ...
    open func defaultIndicatorStyle() -> TabmanBarIndicator.Style {
    ...
    open func add(indicator: TabmanBarIndicator, to contentView: UIView) {
...
extension TabmanBar: TabmanIndicatorDelegate {
    ...
    func indicator(requiresLayoutInvalidation indicator: TabmanBarIndicator) {
        self.invalidateIntrinsicContentSize()
        self.setNeedsLayout()
        self.layoutIfNeeded()
    }
...
internal extension TabmanBarIndicator.Style {
    
    var rawType: TabmanBarIndicator.Type? {
        switch self {
        case .line:
