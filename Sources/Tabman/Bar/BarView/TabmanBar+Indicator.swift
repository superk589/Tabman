...
extension TabmanBar {
    ...
    internal func clear(indicator: BarPageIndicator?) {
    ...
    internal func create(indicatorForStyle style: BarPageIndicator.Style) -> BarPageIndicator? {
    ...
    internal func updateIndicator(forPreferredStyle preferredStyle: BarPageIndicator.Style?) {
